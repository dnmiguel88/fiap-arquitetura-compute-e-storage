...
1. [Issues deste repositório](https://github.com/rafaelmbarbosa/fiap-arquitetura-compute-e-storage/issues) — preferido, cria histórico pesquisável para os próximos alunos.
